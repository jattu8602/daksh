...
import { ArrowLeft, Home, Search, BookOpen, LayoutGrid, User, Calendar } from "lucide-react"
...
export default function TherapyScreen() {
  const [timeLeft, setTimeLeft] = useState({ hours: 8, minutes: 21 })
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white max-w-md mx-auto">
      ...
      {/* Content */}
      <div className="flex flex-col items-center justify-center flex-1 px-6 bg-orange-50">
        {/* Illustration */}
        <motion.div
        ...
        >
          ...
          {/* Animated sparkles */}
          <motion.div
            className="absolute top-10 left-10 w-3 h-3 text-orange-500"
            animate={{
              scale: [1, 1.5, 1],
              opacity: [0.7, 1, 0.7],
            }}
          ...
          <motion.div
            className="absolute top-20 right-20 w-3 h-3 text-orange-500"
            animate={{
              scale: [1, 1.5, 1],
              opacity: [0.7, 1, 0.7],
            }}
        ...
        >
          ...
          >
            You have a therapy session with Dr Freud AI in{" "}
            <motion.span
