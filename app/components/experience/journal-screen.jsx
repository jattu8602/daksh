...
import { ArrowLeft, FileText, Home, Search, BookOpen, LayoutGrid, User } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white max-w-md mx-auto">
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-6">
        ...
        >
          <Image
            src="/images/journal-illustration.png"
          ...
          {/* Animated sparkles */}
          <motion.div
            className="absolute top-10 left-10 w-3 h-3 bg-yellow-300"
          ...
          <motion.div
            className="absolute top-20 right-20 w-2 h-2 bg-yellow-300"
            style={{ borderRadius: "50%" }}
            animate={{
              scale: [1, 1.5, 1],
              opacity: [0.7, 1, 0.7],
        ...
        >
          ...
          >
            You still need to complete <span className="text-yellow-500 font-medium">9 daily</span> journal this month.
            Keep it up!
          </motion.p>
        </motion.div>
